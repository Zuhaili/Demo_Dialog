package sg.edu.rp.c346.id19004781.demodialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnExercise3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Inflate the exercise3input.xml layout file
                LayoutInflater inflater =
                        (LayoutInflater) getBaseContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                ...
                //Obtain the UI component in the input.xml layout
                //It needs to be defined as "final" so that it can used in the onClick() method later
                final EditText etNum1Input = viewDialog.findViewById(R.id.editTextNum1);
                final EditText etNum2Input = viewDialog.findViewById((R.id.editTextNum2));
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // Extract the text entered by the user
                        int num1, num2, sum;
                        num1 = Integer.parseInt(etNum1Input.getText().toString());
                        num2 = Integer.parseInt(etNum2Input.getText().toString());
                        sum = num1 + num2;
                        //Integer message = etNum1Input.getText().toString() + etNum2Input.getText().toString();
                        // Set the text to the TextView
        ...
        btnDemo5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog myTimeDialog = new TimePickerDialog(MainActivity.this, myTimeListener, 20, 0, false);
                myTimeDialog.show();
            }
        });
